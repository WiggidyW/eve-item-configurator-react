...
import App, { EsiApp } from "./App";
import ReactDOM from "react-dom/client";

const businesses: string[] = import.meta.env.VITE_BUSINESSES.split(",").map(
  (s: string) => s.trim()
);
const languages: string[] = import.meta.env.VITE_LANGUAGES.split(",").map(
  (s: string) => s.trim()
);
